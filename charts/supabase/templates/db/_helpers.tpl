...
{{- if .Values.db.legacy.serviceAccount.create }}
{{- default (include "supabase.db.fullname" .) .Values.db.legacy.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.db.legacy.serviceAccount.name }}
{{- end }}
{{- end }}
